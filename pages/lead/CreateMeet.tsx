...
// // ── Add your own number here for testing ─────────────────────────────────────
// const PROFESSORS = [
...
//   // Keep SMS preview in sync with form fields unless user has manually edited it
//   useEffect(() => {
//     if (!smsEdited) {
...
//       navigate('/dashboard');
//     } catch (error) {
//       setValidationError('Failed to create meeting. Please try again.');
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//       body: JSON.stringify({
//   phoneNumber: "+919082888285", // ✅ your number
...
//     } else {
//       throw new Error(); // 🔥 important to trigger fallback
//     }

//   } catch {
//     // 🔥 THIS IS THE MAIN LINE
// window.open(`https://wa.me/919082888285?text=${encodeURIComponent(smsText)}`);
//     setSmsStatus('error');
//     setSmsMessage('Opening SMS app...');
//   }
// };
...
//   //     } else {
//   //       setSmsStatus('error');
//   //       setSmsMessage(data.message || 'SMS failed. Try the fallback link below.');
//   //     }
//   //   } catch {
//   //     setSmsStatus('error');
//   //     setSmsMessage('Cannot reach backend. Make sure backend server is running on port 5000.');
//   //   }
//   // };
...
//                   {formData.type === 'Online'
//                     ? <><strong>Virtual Meet:</strong> Don't forget to paste the Zoom/Meet link in the description.</>
//                     : <><strong>Physical Venue:</strong> Ensure you have booked the venue with Admin 24 hrs prior.</>
//                   }
//                 </p>
//               </div>
//             </div>
...
//             {/* ── Editable SMS Preview (only shows after professor is selected) ── */}
//             {selectedProf && (
