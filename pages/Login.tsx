...
export const Login: React.FC = () => {
    ...
    const fillDemoCredentials = () => {
        // Visual feedback: Flash input backgrounds purple
        if (typeof gsap !== 'undefined') {
            gsap.fromTo("input",
                { backgroundColor: "#E0E7FF" }, // primary-100 / Indigo-100
    ...
    return (
        <div ref={containerRef} className="min-h-screen w-full flex bg-white overflow-hidden font-sans">
            ...
            {/* LEFT PANEL: Branding & Visuals (The "Purple Thing") */}
                ...
                <div ref={formRef} className="w-full max-w-md space-y-8 bg-white p-10 rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100">
                    ...
                    <div className="pt-6 border-t border-slate-100">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 text-sm text-slate-500 hover:text-primary-600 font-medium transition-colors mb-4"
                        >
                        ...
                        {showDemoOptions && (
                            <div className="bg-primary-50/50 p-4 rounded-xl border border-primary-100 animate-fadeIn">
                                <p className="text-xs text-primary-800 mb-3 text-center">
